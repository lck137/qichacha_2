...
class ExtractorQCC():
    ...
    def __init__(self):
        self.data_path = r'./data/data/'
        self.backup_path = r'.backup_data/'  # 文件备份
